...
Christian Blog built in Vue from scratch, uses the Sanity.IO CMS. Features a comment section with DISQUS, Daily verses, article search functionality, sorting by article categories, and bible study resources.
